...
public class MainActivity extends Activity  {
    ...
    private Button button_address_setting;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.main);
            ...
            Save();
            CPU();
        edit_package = (EditText) findViewById(R.id.edit_package);
        edit_lon = (EditText) findViewById(R.id.edit_lon);
        edit_lat = (EditText) findViewById(R.id.edit_lat);
        button_address_setting = (Button) findViewById(R.id.button_address_setting);
        button_address_setting.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String lon_String = edit_lon.getText().toString();
                String lat_String = edit_lat.getText().toString();
                mPackage = edit_package.getText().toString();
                SharedPref mySP = new SharedPref(getApplicationContext());
                mySP.setfloatharedPref("lat", Float.parseFloat(lat_String));
                mySP.setfloatharedPref("lon", Float.parseFloat(lon_String));
            }
        });
    }
